...
def check_equivariance(im, layers, input_array, output_array, point_group, filters):
    ...
    x = tf.compat.v1.placeholder(tf.float32, im.shape)
    output = x
    for layer in layers:
        output = layer(output)
...
@pytest.mark.parametrize('layer,input_array,output_array,point_group,ndim,eq_check,bias_init', [
    (P4ConvZ2, Z2FuncArray, P4FuncArray, c4a, 1, check_equivariance, tf.compat.v1.random_uniform_initializer),
    (P4MConvZ2, Z2FuncArray, P4MFuncArray, d4a, 1, check_equivariance, tf.compat.v1.random_uniform_initializer),
    (P6ConvZ2Axial, Z2FuncArray, P6FuncArray, c6a, 1, check_equivariance_hex, tf.compat.v1.zeros_initializer),
    (P6MConvZ2Axial, Z2FuncArray, P6MFuncArray, d6a, 1, check_equivariance_hex, tf.compat.v1.zeros_initializer),
    (P4ConvP4, P4FuncArray, P4FuncArray, c4a, 4, check_equivariance, tf.compat.v1.random_uniform_initializer),
    (P4MConvP4M, P4MFuncArray, P4MFuncArray, d4a, 8, check_equivariance, tf.compat.v1.random_uniform_initializer),
    (P6ConvP6Axial, P6FuncArray, P6FuncArray, c6a, 6, check_equivariance_hex, tf.compat.v1.zeros_initializer),
    (P6MConvP6MAxial, P6MFuncArray, P6MFuncArray, d6a, 12, check_equivariance_hex, tf.compat.v1.zeros_initializer),
])
...
@pytest.mark.parametrize('layer_1, layer_2,output_array,point_group,eq_check,bias_init', [
    (P4ConvZ2, P4ConvP4, P4FuncArray, c4a, check_equivariance, tf.compat.v1.random_uniform_initializer),
    (P4MConvZ2, P4MConvP4M, P4MFuncArray, d4a, check_equivariance, tf.compat.v1.random_uniform_initializer),
    (P6ConvZ2Axial, P6ConvP6Axial, P6FuncArray, c6a, check_equivariance_hex, tf.compat.v1.zeros_initializer),
    (P6MConvZ2Axial, P6MConvP6MAxial, P6MFuncArray, d6a, check_equivariance_hex, tf.compat.v1.zeros_initializer)
])
@pytest.mark.parametrize('filters', [1, 3])
