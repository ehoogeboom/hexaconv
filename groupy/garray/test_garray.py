...
# Not closed under inverses due to boundary effects.
# def test_p6_array():
#     from groupy.garray import p6_array
#     check_wallpaper_group(p6_array, p6_array.P6Array)
...
# def test_p6m_array():
#     from groupy.garray import p6m_array
#     check_wallpaper_group(p6m_array, p6m_array.P6MArray)
...
def test_c6_array():
    from groupy.garray import C6_array
    check_finite_group(C6_array, C6_array.C6Array, C6_array.C6)
...
def test_d6_array():
    from groupy.garray import D6_array
    check_finite_group(D6_array, D6_array.D6Array, D6_array.D6)


def test_m3m_array():
    from groupy.garray import m3m_array
    check_finite_group(m3m_array, m3m_array.M3MArray, m3m_array.m3m)
