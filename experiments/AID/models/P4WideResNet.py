...
class P4WideResNet(ChainList):
    def __init__(self, num_blocks=2, nc32=18, nc16=36, nc8=74, k=1,
                 drop_ratio=0.0):
        """
        ...
        super(P4WideResNet, self).__init__()

        # The first layer is always a convolution.
        self.add_link(
            P4ConvZ2(in_channels=3, out_channels=nc32, ksize=3, stride=2,
                     pad=1, wscale=ws)
        )
        ...
        for i in range(num_blocks):
            ...
            self.add_link(
                WideResBlock2D(
                    ...
                    downsample=False, ConvLink=P4ConvP4,
        ...
        for i in range(num_blocks):
            ...
            self.add_link(
                WideResBlock2D(
                    ...
                    downsample=downsample, ConvLink=P4ConvP4,
                    drop_ratio=drop_ratio))
        ...
        # self.add_link(
        #     L.Convolution2D(in_channels=nc8 * k * 4, out_channels=30,
        #                     ksize=1, wscale=ws))
