...
class P6WideResNet(ChainList):

    def __init__(self, num_blocks=2, nc32=17, nc16=34, nc8=68, k=1,
                 drop_ratio=0.0, n_outputs=30):
        """
        ...
        self.add_link(
            P6ConvZ2(in_channels=3, out_channels=nc32, ksize=3, stride=2,
                     pad=1, wscale=ws)
        )
        ...
        # self.add_link(
        #     L.Convolution2D(in_channels=nc8 * k * 6, out_channels=30,
        #                     ksize=1, wscale=ws))
