...
class P6MWideResNet(ChainList):
    ...
    def __init__(self, num_blocks=2, nc32=12, nc16=24, nc8=48, k=1,
                 drop_ratio=0.0):
        """
        ...
        self.add_link(
            P6MConvZ2(in_channels=3, out_channels=nc32, ksize=3, stride=2,
                      pad=1, wscale=ws)
        )
        ...
        # self.add_link(
        #     L.Convolution2D(in_channels=nc8 * k * 12, out_channels=30,
        #                     ksize=1, wscale=ws))
