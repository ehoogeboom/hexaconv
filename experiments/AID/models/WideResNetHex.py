...
class WideResNetHex(ChainList):
    def __init__(self, num_blocks=2, nc32=42, nc16=83, nc8=166, k=1,
                 drop_ratio=0.0):
        """
        ...
        self.add_link(
            HexConv2D(in_channels=3, ksize=3, pad=1, stride=2,
        ...
        self.add_link(
            L.Convolution2D(
                in_channels=nc8 * k, ksize=1, out_channels=30, wscale=ws))
