...
class P4MWideResNet(ChainList):
    ...
    def __init__(self, num_blocks=4, nc32=5, nc16=12, nc8=21, k=1,
                 drop_ratio=0.0):
        """
        ...
        self.add_link(
            P4MConvZ2(in_channels=3, out_channels=nc32, ksize=3, stride=1,
                      pad=1, wscale=ws)
        )
        ...
        self.add_link(
            L.Convolution2D(in_channels=nc8 * k * 8, out_channels=10, ksize=1,
                            wscale=ws))
