...
class P4WideResNet(ChainList):
    def __init__(self, num_blocks=4, nc32=8, nc16=16, nc8=30, k=1,
                 drop_ratio=0.0):
        """
        ...
        self.add_link(
            P4ConvZ2(in_channels=3, out_channels=nc32, ksize=3, stride=1,
                     pad=1, wscale=ws)
        )
        ...
        self.add_link(
            L.Convolution2D(in_channels=nc8 * k * 4, out_channels=10, ksize=1,
                            wscale=ws))
